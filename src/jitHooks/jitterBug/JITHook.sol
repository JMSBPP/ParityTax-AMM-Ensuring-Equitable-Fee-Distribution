...
abstract contract JITHook is JIT {
    ...
    /// @dev No tokens should be transferred into the PoolManager by this function.
    //  The afterSwap implementation, will handle token flows
    ...
    /// @notice Defines logic to retreive external capital to the PoolManager
    //  (to settle the JIT position)
